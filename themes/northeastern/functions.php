...
require_once(get_template_directory()."/includes/theme-update-checker/plugin-update-checker.php");
//require '/functions/theme-update-checker/plugin-update-checker.php';
$myUpdateChecker = Puc_v4_Factory::buildUpdateChecker(
	'http://branding.nudev.net/theme.json',
